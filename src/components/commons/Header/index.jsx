...
class Header extends Component {
  ...
  render() {
    const { hidden, authHidden, showSearchBar, showSignUpModal } = this.state;
    const { user, isAuthenticated } = this.props;
    const { username } = user;

    const firstname = 'Emmanuel';
    const lastname = 'Okwara';
    const avatar = 'public/img/logo.png';
    ...
    return (
      <Fragment>
        ...
        {showSignUpModal ? (
          <Modal
            title={`Join Author's Haven`}
            exitModal={this.toggleSignUpDialog}
            toggle
          >
            {<SignupPage />}
          </Modal>
